...
# Initial position of tracker ball
x, y, r = 100, 100, 40
...
while True:
    ...
    if waittime % 100 == 0: # Wait time to give time for user to interpret information

        # Direction
        dirr = ((x-x_prev)**2 + (y-y_prev)**2)**0.5 # Distance travelled between frames
        dir_x = (x-x_prev)
        dir_y = (y-y_prev)
        ...
        if dir_x !=0 and dir_y !=0: # Given ball's flickering, mistakes might occur
